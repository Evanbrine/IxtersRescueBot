...
def setup_loggers():
    ...
    command_handler = logging.FileHandler(command_log_file, encoding='cp1251')  # Указываем кодировку ANSI
    ...
    chat_handler = logging.FileHandler(chat_log_file, encoding='cp1251')  # Указываем кодировку ANSI
